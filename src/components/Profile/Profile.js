        ...
        <form onSubmit={handleSubmit}>
          <fieldset className='profile__info'>
            ...
            <input type='text' name='username' className='profile__input' value={userName} id='username' 
                   minLength={2} required onChange={handleUserNameChange} placeholder='Имя' />
          </fieldset>
          <span className='profile__input-error'>{validation.errors.username}</span>
          <hr className='profile__line' />
          <fieldset className='profile__info'>
            <label className='profile__label'>E-mail</label>
            <input type='email' name='email' className='profile__input' value={email} id='useremail' required 
